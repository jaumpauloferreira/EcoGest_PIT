...
export default function CaixaSelecaoTramitar({ enderecoFonteDados, campoChave, campoExibicao, funcaoSelecao }) {
                ...
                <Col md={11}>
                    ...
                    >
                        ...
                        {dados.length > 0 ? (
                            ...
                            <option value="" disabled>Nenhuma secretaria disponível</option>
                        )}
                    </Form.Select>
                </Col>
